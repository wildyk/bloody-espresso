...
function DeleteProduk({ id }) {
    const handleSubmit = async (formData)=>{
        if (confirm('Apakah Anda yakin ingin menghapus produk ini?')) {
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$lib$2f$actions$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["deleteMenu"])(id);
        }
    };
...
//# sourceMappingURL=src_app_f3143665._.js.map